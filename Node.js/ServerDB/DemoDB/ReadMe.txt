# Getting Started with LocalDB Demo

This guide will help you set up and run the LocalDB demo project using Node.js.
...
git clone https://github.com/AlexPlec/ServerDB-DemoDB.git
